...
function fetchProvinces() {
    const apiUrl = 'https://api.goapi.io/regional/provinsi?api_key=cbfbc4f4-4224-500a-4ade-9f24a1c9';
...
function fetchCities() {
    ...
    const apiUrl = `https://api.goapi.io/regional/kota?api_key=cbfbc4f4-4224-500a-4ade-9f24a1c9&provinsi_id=${provinceId}`;
